  ...
  return (
    <main className={`w-full bg-[#fdecc9] flex items-center my-30 justify-center p-6" ${inter.className}`}>
      <div className="w-full relative max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl">
        ...
        {/* Right: form panel */}
        <form className={`bg-[#4b2f1e] flex flex-col justify-between h-full z-0 text-white px-8 sm:px-10 py-10`}>
          ...
          <div className="pt-16 max-w-md mx-auto w-full">
            <label className="block text-sm font-semibold mt-6 mb-2">Nombre</label>
            ...
            {/* Email */}
            <label className="block text-sm font-semibold mt-6 mb-2">Correo electrónico</label>
            <div className="flex items-center gap-2 bg-transparent border-b border-white/50 focus-within:border-white transition">
              <input
                type="email"
            ...
            <label className="block text-sm font-semibold mt-6 mb-2">Telefono</label>
            <div className="flex items-center gap-2 bg-transparent border-b border-white/50 focus-within:border-white transition">
              <input
            ...
            <label className="block text-sm font-semibold mt-6 mb-2">Dirección</label>
            <div className="flex items-center gap-2 bg-transparent border-b border-white/50 focus-within:border-white transition">
              <input
                type="email"
            ...
            <label className="block text-sm font-semibold mt-6 mb-2">Localidad</label>
            <div className="flex items-center gap-2 bg-transparent border-b border-white/50 focus-within:border-white transition">
              <select className="w-full py-1" name="" id="">
                <option className="text-black" value="Lanus">Lanús</option>
                <option className="text-black" value="Gerli">Gerli</option>
                <option className="text-black" value="Avellaneda">Avellaneda</option>
              </select>
            </div>
            <label className="block text-sm font-semibold mt-6 mb-2">Piso/Depto (opcional)</label>
            <div className="flex items-center gap-2 bg-transparent border-b border-white/50 focus-within:border-white transition">
              <input
                type="email"
                placeholder="Ej: Piso 10"
                className="w-full bg-transparent outline-none py-3 placeholder:text-white/70"
              />
            </div>
            ...
            {/* Submit */}
            <button type="submit" className="mt-6 w-full cursor-pointer rounded-xl py-3 font-semibold bg-[#b36912] text-black hover:bg-[#a35f0f] active:scale-[.99] transition">
              Registrarse
            </button>
            ...
            <p className="text-center text-sm">
              ...
              <Link href="/login" className="text-[#ffd21f] hover:underline font-semibold">Inicia sesión</Link>
            </div>
          </div>
        </form>
      </div>

...
const ModalPromos = ({ product }) => {
  ...
  const handleAddToCart = () => {
    ...
    if (selectedProduct.description_list && selectedProduct.description_list.length > 0) {
          ...
          >
            <div className="relative bg-primary">
              <div>
                ...
                {selectedProduct.description_list && selectedProduct.description_list.length > 0 && (
                  <div className="mb-6 px-6 flex flex-col gap-2">
                    ...
                    <div className="flex flex-col justify-between items-start mt-2 gap-2">
                      {selectedProduct.description_list.map((option) => (
                        <div key={option} className="flex justify-between text-white font-light items-center w-full gap-2">
                          <p>{option}</p>
                          <input
                            type="checkbox"
